...
void interp2Dexpl_eval_dB(real* B_dB, interp2D_data* str, real r, real z) {
    ...
    /* df/dr */
    B_dB[1] = str->c[n+ 1]+2*dr*str->c[n+ 2]+3*dr2*str->c[n+ 3]
