...
*
* \f$E_\mathrm{kin}=(\gamma(v) - 1) * m c^2\f$
*
* where
*
* - \f$m\f$ is mass [kg]
...
*
* \f$E_\mathrm{kin}=(\gamma(m, \mu, v_\parallel, B) - 1) * m c^2\f$
*
* where
*
* - \f$m\f$ is mass [kg]
...
*
* \f$v_\parallel = \xi v_\parallel\f$
*
* where
*
* - \f$v\f$ is velocity norm [m/s]
...
*
* \f$v = \sqrt{v_\parallel^2 + 2\mu B / m\gamma(m,\mu,v_\parallel,B)}\f$
*
* where
*
* - \f$m\f$ is mass [kg]
 ...
 * - \f$m\f$ is mass [kg]
 * - \f$q\f$ is charge [C]
 * - \f$\mathbf{v}\f$ is velocity vector [m/s]
