 ...
 * E[2] = Ez
 *
 * This is otherwise identical to E_field_eval_E() except E is a SIMD array.
 *
 * @deprecated This is not being used in the code
 * @todo Should this function be removed?
 *
 * @param i location in SIMD array for which electric field is evaluated
 * @param E pointer to array where electric field values are stored
 * @param r R coordinate [m]
 * @param phi phi coordinate [deg]
 * @param z z coordinate [m]
 ...
 * @return Non-zero a5err value if evaluation failed, zero otherwise
 */
a5err E_field_eval_E_SIMD(int i, real E[3][NSIMD], real r, real phi, real z,
