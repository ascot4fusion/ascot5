...
a5err E_3D_eval_E(real E[], real r, real phi, real z, E_3D_data* Edata);
#pragma omp declare simd linear(i) uniform(E, Edata)
a5err E_3D_eval_E_SIMD(int i, real E[3][NSIMD], real r, real phi, real z, E_3D_data* Edata);
