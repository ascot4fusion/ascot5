...
# i -options class (defined at the start of this file)
# fn -filename for hdf5-file
def writeHdf5(i,fn):
    f = h5py.File(fn, "w")
    o = f.create_group("options")

    o.create_dataset("SIM_MODE", data = i.SIM_MODE, dtype='i4')
    o.create_dataset("ENABLE_ADAPTIVE", data = i.ENABLE_ADAPTIVE, dtype='i4')
    o.create_dataset("RECORD_GO_AS_GC", data = i.RECORD_GO_AS_GC, dtype='i4')
    o.create_dataset("FIXEDSTEP_USE_USERDEFINED", data = i.FIXEDSTEP_USE_USERDEFINED, dtype='i4')
    o.create_dataset("FIXEDSTEP_USERDEFINED", data = i.FIXEDSTEP_USERDEFINED, dtype='f8')
    o.create_dataset("FIXEDSTEP_NSTEPS_PER_GYROTIME", data = i.FIXEDSTEP_NSTEPS_PER_GYROTIME, dtype='i4')
    o.create_dataset("ADAPTIVE_TOL_ORBIT", data = i.ADAPTIVE_TOL_ORBIT, dtype='f8')
    o.create_dataset("ADAPTIVE_TOL_CCOL", data = i.ADAPTIVE_TOL_CCOL, dtype='f8')
    o.create_dataset("ADAPTIVE_MAX_DRHO", data = i.ADAPTIVE_MAX_DRHO, dtype='f8')
    o.create_dataset("ADAPTIVE_MAX_DPHI", data = i.ADAPTIVE_MAX_DPHI, dtype='f8')
    o.create_dataset("ADAPTIVE_MAX_ACC", data = i.ADAPTIVE_MAX_ACC, dtype='f8')
    o.create_dataset("ENDCOND_SIMTIMELIM", data = i.ENDCOND_SIMTIMELIM, dtype='i4')
    o.create_dataset("ENDCOND_CPUTIMELIM", data = i.ENDCOND_CPUTIMELIM, dtype='i4')
    o.create_dataset("ENDCOND_RHOLIM", data = i.ENDCOND_RHOLIM, dtype='i4')
    o.create_dataset("ENDCOND_ENERGYLIM", data = i.ENDCOND_ENERGYLIM, dtype='i4')
    o.create_dataset("ENDCOND_WALLHIT", data = i.ENDCOND_WALLHIT, dtype='i4')
    o.create_dataset("ENDCOND_MAXORBS", data = i.ENDCOND_MAXORBS, dtype='i4')
    o.create_dataset("ENDCOND_MAX_SIM_TIME", data = i.ENDCOND_MAX_SIM_TIME, dtype='f8')
    o.create_dataset("ENDCOND_MAX_CPU_TIME", data = i.ENDCOND_MAX_CPU_TIME, dtype='f8')
    o.create_dataset("ENDCOND_MAX_RHO", data = i.ENDCOND_MAX_RHO, dtype='f8')
    o.create_dataset("ENDCOND_MIN_RHO", data = i.ENDCOND_MIN_RHO, dtype='f8')
    o.create_dataset("ENDCOND_MIN_ENERGY", data = i.ENDCOND_MIN_ENERGY, dtype='f8')
    o.create_dataset("ENDCOND_MIN_ENERGY_TIMES_THERMAL", data = i.ENDCOND_MIN_ENERGY_TIMES_THERMAL, dtype='f8')
    o.create_dataset("ENDCOND_MAX_TOROIDALORBS", data = i.ENDCOND_MAX_TOROIDALORBS, dtype='i4')
    o.create_dataset("ENDCOND_MAX_POLOIDALORBS", data = i.ENDCOND_MAX_POLOIDALORBS, dtype='i4')
    o.create_dataset("ENABLE_ORBIT_FOLLOWING", data = i.ENABLE_ORBIT_FOLLOWING, dtype='i4')
    o.create_dataset("ENABLE_COULOMB_COLLISIONS", data = i.ENABLE_COULOMB_COLLISIONS, dtype='i4')
    o.create_dataset("ENABLE_RZVparaVperp_DIST", data = i.ENABLE_RZVparaVperp_DIST, dtype='i4')
    o.create_dataset("DIST_RZVparaVperp_MIN_R", data = i.DIST_RZVparaVperp_MIN_R, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_MAX_R", data = i.DIST_RZVparaVperp_MAX_R, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_BIN_R", data = i.DIST_RZVparaVperp_BIN_R, dtype='i4')
    o.create_dataset("DIST_RZVparaVperp_MIN_Z", data = i.DIST_RZVparaVperp_MIN_Z, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_MAX_Z", data = i.DIST_RZVparaVperp_MAX_Z, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_BIN_Z", data = i.DIST_RZVparaVperp_BIN_Z, dtype='i4')
    o.create_dataset("DIST_RZVparaVperp_MIN_VPARA", data = i.DIST_RZVparaVperp_MIN_VPARA, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_MAX_VPARA", data = i.DIST_RZVparaVperp_MAX_VPARA, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_BIN_VPARA", data = i.DIST_RZVparaVperp_BIN_VPARA, dtype='i4')
    o.create_dataset("DIST_RZVparaVperp_MIN_VPERP", data = i.DIST_RZVparaVperp_MIN_VPERP, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_MAX_VPERP", data = i.DIST_RZVparaVperp_MAX_VPERP, dtype='f8')
    o.create_dataset("DIST_RZVparaVperp_BIN_VPERP", data = i.DIST_RZVparaVperp_BIN_VPERP, dtype='i4')
    o.create_dataset("ENABLE_ORBITWRITE", data = i.ENABLE_ORBITWRITE, dtype='i4')
    o.create_dataset("ORBITWRITE_MODE", data = i.ORBITWRITE_MODE, dtype='i4')
    o.create_dataset("ORBITWRITE_NTOROIDALPLOTS", data = i.ORBITWRITE_NTOROIDALPLOTS, dtype='i4')
    o.create_dataset("ORBITWRITE_TOROIDALANGLES", data = i.ORBITWRITE_TOROIDALANGLES, dtype='f8')
    o.create_dataset("ORBITWRITE_NPOLOIDALPLOTS", data = i.ORBITWRITE_NPOLOIDALPLOTS, dtype='i4')
    o.create_dataset("ORBITWRITE_POLOIDALANGLES", data = i.ORBITWRITE_POLOIDALANGLES, dtype='f8')
    o.create_dataset("ORBITWRITE_INTERVAL", data = i.ORBITWRITE_INTERVAL, dtype='f8')
    o.create_dataset("ORBITWRITE_LASTNPOINTS", data = i.ORBITWRITE_LASTNPOINTS, dtype='i4')
    o.create_dataset("ENABLE_DEBUGDIST", data = i.ENABLE_DEBUGDIST, dtype='i4')
