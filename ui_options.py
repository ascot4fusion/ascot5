...
o.create_dataset("ENABLE_ADAPTIVE", data = ENABLE_ADAPTIVE, dtype='i4')
o.create_dataset("RECORD_GO_AS_GC", data = RECORD_GO_AS_GC, dtype='i4')
o.create_dataset("FIXEDSTEP_USE_USERDEFINED", data = FIXEDSTEP_USE_USERDEFINED, dtype='i4')
o.create_dataset("FIXEDSTEP_USERDEFINED", data = FIXEDSTEP_USERDEFINED, dtype='f8')
o.create_dataset("FIXEDSTEP_NSTEPS_PER_GYROTIME", data = FIXEDSTEP_NSTEPS_PER_GYROTIME, dtype='i4')
o.create_dataset("ADAPTIVE_TOL_ORBIT", data = ADAPTIVE_TOL_ORBIT, dtype='f8')
o.create_dataset("ADAPTIVE_TOL_CCOL", data = ADAPTIVE_TOL_CCOL, dtype='f8')
o.create_dataset("ADAPTIVE_MAX_DRHO", data = ADAPTIVE_MAX_DRHO, dtype='f8')
o.create_dataset("ADAPTIVE_MAX_DPHI", data = ADAPTIVE_MAX_DPHI, dtype='f8')
o.create_dataset("ADAPTIVE_MAX_ACC", data = ADAPTIVE_MAX_ACC, dtype='f8')
o.create_dataset("ENDCOND_SIMTIMELIM", data = ENDCOND_SIMTIMELIM, dtype='i4')
o.create_dataset("ENDCOND_CPUTIMELIM", data = ENDCOND_CPUTIMELIM, dtype='i4')
o.create_dataset("ENDCOND_RHOLIM", data = ENDCOND_RHOLIM, dtype='i4')
o.create_dataset("ENDCOND_ENERGYLIM", data = ENDCOND_ENERGYLIM, dtype='i4')
o.create_dataset("ENDCOND_WALLHIT", data = ENDCOND_WALLHIT, dtype='i4')
o.create_dataset("ENDCOND_MAXORBS", data = ENDCOND_MAXORBS, dtype='i4')
o.create_dataset("ENDCOND_MAX_SIM_TIME", data = ENDCOND_MAX_SIM_TIME, dtype='f8')
o.create_dataset("ENDCOND_MAX_CPU_TIME", data = ENDCOND_MAX_CPU_TIME, dtype='f8')
o.create_dataset("ENDCOND_MAX_RHO", data = ENDCOND_MAX_RHO, dtype='f8')
o.create_dataset("ENDCOND_MIN_RHO", data = ENDCOND_MIN_RHO, dtype='f8')
o.create_dataset("ENDCOND_MIN_ENERGY", data = ENDCOND_MIN_ENERGY, dtype='f8')
o.create_dataset("ENDCOND_MIN_ENERGY_TIMES_THERMAL", data = ENDCOND_MIN_ENERGY_TIMES_THERMAL, dtype='f8')
o.create_dataset("ENDCOND_MAX_TOROIDALORBS", data = ENDCOND_MAX_TOROIDALORBS, dtype='i4')
o.create_dataset("ENDCOND_MAX_POLOIDALORBS", data = ENDCOND_MAX_POLOIDALORBS, dtype='i4')
o.create_dataset("ENABLE_ORBIT_FOLLOWING", data = ENABLE_ORBIT_FOLLOWING, dtype='i4')
o.create_dataset("ENABLE_COULOMB_COLLISIONS", data = ENABLE_COULOMB_COLLISIONS, dtype='i4')
o.create_dataset("ENABLE_RZVparaVperp_DIST", data = ENABLE_RZVparaVperp_DIST, dtype='i4')
o.create_dataset("DIST_RZVparaVperp_MIN_R", data = DIST_RZVparaVperp_MIN_R, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_MAX_R", data = DIST_RZVparaVperp_MAX_R, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_BIN_R", data = DIST_RZVparaVperp_BIN_R, dtype='i4')
o.create_dataset("DIST_RZVparaVperp_MIN_Z", data = DIST_RZVparaVperp_MIN_Z, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_MAX_Z", data = DIST_RZVparaVperp_MAX_Z, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_BIN_Z", data = DIST_RZVparaVperp_BIN_Z, dtype='i4')
o.create_dataset("DIST_RZVparaVperp_MIN_VPARA", data = DIST_RZVparaVperp_MIN_VPARA, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_MAX_VPARA", data = DIST_RZVparaVperp_MAX_VPARA, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_BIN_VPARA", data = DIST_RZVparaVperp_BIN_VPARA, dtype='i4')
o.create_dataset("DIST_RZVparaVperp_MIN_VPERP", data = DIST_RZVparaVperp_MIN_VPERP, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_MAX_VPERP", data = DIST_RZVparaVperp_MAX_VPERP, dtype='f8')
o.create_dataset("DIST_RZVparaVperp_BIN_VPERP", data = DIST_RZVparaVperp_BIN_VPERP, dtype='i4')
o.create_dataset("ENABLE_ORBITWRITE", data = ENABLE_ORBITWRITE, dtype='i4')
o.create_dataset("ORBITWRITE_MODE", data = ORBITWRITE_MODE, dtype='i4')
o.create_dataset("ORBITWRITE_NTOROIDALPLOTS", data = ORBITWRITE_NTOROIDALPLOTS, dtype='i4')
o.create_dataset("ORBITWRITE_TOROIDALANGLES", data = ORBITWRITE_TOROIDALANGLES, dtype='f8')
o.create_dataset("ORBITWRITE_NPOLOIDALPLOTS", data = ORBITWRITE_NPOLOIDALPLOTS, dtype='i4')
o.create_dataset("ORBITWRITE_POLOIDALANGLES", data = ORBITWRITE_POLOIDALANGLES, dtype='f8')
o.create_dataset("ORBITWRITE_INTERVAL", data = ORBITWRITE_INTERVAL, dtype='f8')
o.create_dataset("ORBITWRITE_LASTNPOINTS", data = ORBITWRITE_LASTNPOINTS, dtype='i4')
o.create_dataset("ENABLE_DEBUGDIST", data = ENABLE_DEBUGDIST, dtype='i4')
