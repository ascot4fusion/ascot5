...
def init():
    ...
    boozer.write_hdf5_dummy(test_ascot.testfn, desc="THERMAL_GO")
    boozer.write_hdf5_dummy(test_ascot.testfn, desc="THERMAL_GCF")
    boozer.write_hdf5_dummy(test_ascot.testfn, desc="THERMAL_GCA")
    boozer.write_hdf5_dummy(test_ascot.testfn, desc="SLOWING_GO")
    boozer.write_hdf5_dummy(test_ascot.testfn, desc="SLOWING_GCF")
    boozer.write_hdf5_dummy(test_ascot.testfn, desc="SLOWING_GCA")
    mhd.write_hdf5_dummy(test_ascot.testfn, desc="THERMAL_GO")
    mhd.write_hdf5_dummy(test_ascot.testfn, desc="THERMAL_GCF")
    mhd.write_hdf5_dummy(test_ascot.testfn, desc="THERMAL_GCA")
    mhd.write_hdf5_dummy(test_ascot.testfn, desc="SLOWING_GO")
    mhd.write_hdf5_dummy(test_ascot.testfn, desc="SLOWING_GCF")
    mhd.write_hdf5_dummy(test_ascot.testfn, desc="SLOWING_GCA")
