...
def init():
    ...
    if use_spline:
        ...
        B_GS.write_hdf5_B_2D(test_ascot.testfn, R0, z0, Bphi0, psi_mult,
    ...
    #**************************************************************************#
    Exyz   = np.array([0, 0, 0])
    E_TC.write_hdf5(test_ascot.testfn, Exyz, desc="ORBFOL_GO")
    E_TC.write_hdf5(test_ascot.testfn, Exyz, desc="ORBFOL_GCF")
    E_TC.write_hdf5(test_ascot.testfn, Exyz, desc="ORBFOL_GCA")

    nwall = 4
    Rwall = np.array([0.1, 100, 100, 0.1])
    zwall = np.array([-100, -100, 100, 100])
    W_2D.write_hdf5(test_ascot.testfn, nwall, Rwall, zwall, desc="ORBFOL_GO")
    W_2D.write_hdf5(test_ascot.testfn, nwall, Rwall, zwall, desc="ORBFOL_GCF")
    W_2D.write_hdf5(test_ascot.testfn, nwall, Rwall, zwall, desc="ORBFOL_GCA")
