# -*- coding: utf-8 -*-
#
# TARGET arch is: ['-I/home/giacomo/miniconda3/envs/ascot-dev/include/', '-I/home/giacomo/miniconda3/envs/ascot-dev/x86_64-conda-linux-gnu/sysroot/usr/include/', '-I/home/giacomo/miniconda3/envs/ascot-dev/lib/clang/15.0.7/include/']
# WORD_SIZE is: 8
# POINTER_SIZE is: 8
...
struct_rfof_marker._pack_ = 1 # source:False
struct_rfof_marker._fields_ = [
    ('p', ctypes.POINTER(None) * 16),
    ('history_array', ctypes.POINTER(None) * 16),
    ('diag_array', ctypes.POINTER(None) * 16),
    ('nrow', ctypes.c_int32 * 16),
    ('ncol', ctypes.c_int32 * 16),
]
...
try:
    ...
    pass
try:
    afsi_run_new = _libraries['libascot.so'].afsi_run_new
    afsi_run_new.restype = None
    afsi_run_new.argtypes = [ctypes.POINTER(struct_c__SA_sim_data), ctypes.POINTER(struct_c__SA_afsi_data), ctypes.c_int32, ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double), ctypes.POINTER(ctypes.c_double)]
except AttributeError:
    pass
try:
...
__all__ = \
    ...
    'afsi_data', 'afsi_run', 'afsi_run_new', 'asigma_data',
    ...
    'plasma_1DS_eval_flow', 'plasma_1DS_eval_temp', 'plasma_1DS_free',
    'plasma_1DS_init', 'plasma_1DS_offload', 'plasma_1D_data',
    'plasma_1D_eval_dens', 'plasma_1D_eval_densandtemp',
    'plasma_1D_eval_flow', 'plasma_1D_eval_temp', 'plasma_1D_free',
    ...
    'wall_type_3D', 'write_output', 'write_rungroup']
