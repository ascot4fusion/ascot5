    ...
    *managed by the tree*. Each leaf contains metadata: `date` when the data was
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._variant: str = self.__class__.__name__
        """Name of this leave."""
    ...
    def save(self) -> None:
        ...
        self._save_and_free_data()

    def _save_and_free_data(self) -> None:
        """Save the actual data and free any resources."""
        self._save_data()
        self._free_data()
    ...
    def _free_data(self) -> None:
        """Free any resources after data has been saved to disk."""
    ...
    def register(cls, subclass) -> type:
        ...
        Use this as a decorator for subclasses so that their instances can
        be created with :meth:`.create_leaf` factory method.
        """
        variant = subclass.__name__
