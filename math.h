...
#define math_matcopy(a,b) (a[0]=b[0],a[1]=b[1],a[2]=b[2],a[3]=b[3],a[4]=b[4],\
...
#define math_cross(a,b,c) (c[0]=a[1]*b[2]-a[2]*b[1],c[1]=a[2]*b[0]-a[0]*b[2],\
                           c[2] = a[0]*b[1] - a[1]*b[0])
...
#define math_matsumew(a,b) (a[0]=a[0]+b[0],a[1]=a[1]+b[1],a[2]=a[2]+b[2],\
                            a[3]=a[3]+b[3],a[4]=a[4]+b[4],a[5]=a[5]+b[5],\
                            a[6]=a[6]+b[6],a[7]=a[7]+b[7],a[8]=a[8]+b[8])

/** @brief Multiply matrix elements with a scalar a = b*a */
#define math_matprod(a,b) (a[0]=a[0]*b,a[1]=a[1]*b,a[2]=a[2]*b,a[3]=a[3]*b,\
                           a[4]=a[4]*b,a[5]=a[5]*b,a[6]=a[6]*b,a[7]=a[7]*b,\
                           a[8]=a[8]*b)
