...
void simulate_copy_to_gpu(sim_data* sim) {
    ...
    case E_field_type_TC:
        GPU_MAP_TO_DEVICE(
        sim->E_data.ETC,sim->E_data.ETC.Exyz[0:3] )
        break;
    default:
        break;
    }
    ...
    case plasma_type_1D:
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1D.mass       [0:sim->plasma_data.plasma_1D.n_species],\
            sim->plasma_data.plasma_1D.charge     [0:sim->plasma_data.plasma_1D.n_species],\
            sim->plasma_data.plasma_1D.anum       [0:sim->plasma_data.plasma_1D.n_species-1],\
            sim->plasma_data.plasma_1D.znum       [0:sim->plasma_data.plasma_1D.n_species-1],\
    ...
    case plasma_type_1Dt:
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1Dt.mass      [0:sim->plasma_data.plasma_1Dt.n_species],\
            sim->plasma_data.plasma_1Dt.charge    [0:sim->plasma_data.plasma_1Dt.n_species],\
            sim->plasma_data.plasma_1Dt.anum      [0:sim->plasma_data.plasma_1Dt.n_species-1],\
            sim->plasma_data.plasma_1Dt.znum      [0:sim->plasma_data.plasma_1Dt.n_species-1],\
    ...
    case plasma_type_1DS:
        GPU_MAP_TO_DEVICE(
            sim->plasma_data)
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1DS)
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1DS.mass      [0:sim->plasma_data.plasma_1DS.n_species])
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1DS.charge    [0:sim->plasma_data.plasma_1DS.n_species])
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1DS.anum      [0:sim->plasma_data.plasma_1DS.n_species-1])
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1DS.znum      [0:sim->plasma_data.plasma_1DS.n_species-1])
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1DS.temp      [0:2])
        GPU_MAP_TO_DEVICE(
            sim->plasma_data.plasma_1DS.dens      [0:sim->plasma_data.plasma_1DS.n_species])
        GPU_MAP_TO_DEVICE(
        ...
        for (int i=0;i<sim->plasma_data.plasma_1DS.n_species;i++) {
            GPU_MAP_TO_DEVICE(
