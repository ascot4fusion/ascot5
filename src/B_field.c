    ...
    real psi[1], real r, real phi, real z, real t, B_field_data *bfield)
{
    ...
    {
    case B_field_type_analytical:
        err = BfieldAnalytical_eval_psi(psi, r, phi, z, bfield->analytical);
        break;

    case B_field_type_spline2d:
        err = BfieldSpline2D_eval_psi(psi, r, phi, z, bfield->spline2d);
        break;

    case B_field_type_spline3d:
        err = BfieldSpline3D_eval_psi(psi, r, phi, z, bfield->spline3d);
        break;
    ...
    real psi_dpsi[4], real r, real phi, real z, real t, B_field_data *bfield)
{
    ...
    {
    case B_field_type_analytical:
        err = BfieldAnalytical_eval_psi_dpsi(
            psi_dpsi, r, phi, z, bfield->analytical);
        break;

    case B_field_type_spline2d:
        err =
            BfieldSpline2D_eval_psi_dpsi(psi_dpsi, r, phi, z, bfield->spline2d);
        break;

    case B_field_type_spline3d:
        err =
            BfieldSpline3D_eval_psi_dpsi(psi_dpsi, r, phi, z, bfield->spline3d);
        break;
    ...
    real rho_drho[4], real r, real phi, real z, B_field_data *bfield)
{
    ...
    {
    case B_field_type_analytical:
        err = BfieldAnalytical_eval_rho_drho(
            rho_drho, r, phi, z, bfield->analytical);
        break;

    case B_field_type_spline2d:
        err =
            BfieldSpline2D_eval_rho_drho(rho_drho, r, phi, z, bfield->spline2d);
        break;

    case B_field_type_spline3d:
        err =
            BfieldSpline3D_eval_rho_drho(rho_drho, r, phi, z, bfield->spline3d);
        break;
    ...
    real b[3], real r, real phi, real z, real t, B_field_data *bfield)
{
    ...
    case B_field_type_spline2d:
        err = BfieldSpline2D_eval_b(b, r, phi, z, bfield->spline2d);
        break;
    ...
    real b_db[15], real r, real phi, real z, real t, B_field_data *bfield)
{
    ...
    case B_field_type_spline2d:
        err = BfieldSpline2D_eval_b_db(b_db, r, phi, z, bfield->spline2d);
        break;
...
a5err B_field_get_axis_rz(real axisrz[2], B_field_data *bfield, real phi)
{
    a5err err = 0;
