 ...
 */
typedef struct {
    linint3D_data E_r;   /**< pointer to E_r interpolation data struct   */
    linint3D_data E_phi; /**< pointer to E_phi interpolation data struct */
    linint3D_data E_z;   /**< pointer to E_z interpolation data struct   */
