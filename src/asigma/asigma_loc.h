...
typedef struct {
    ...
    int* q_1;                 /**< Charge state of test particle   */
    int* z_2;                 /**< Atomic number of bulk particle  */
    int* a_2;                 /**< Mass number of bulk particle    */
    int* q_2;                 /**< Charge state of bulk particle   */
...
a5err asigma_loc_eval_eii(
    real* sigmav, int z_1, int a_1, int q_1, real E, real mass, real Te,
    real ne, int extrapolate, asigma_loc_data* asigmadata);
#endif
