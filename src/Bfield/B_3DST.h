...
typedef struct {
    ...
    real psigrid_r_min;      /**< min r coordinate in the grid in psi data */
    real psigrid_r_max;      /**< max r coordinate in the grid in psi data */
    real psigrid_z_min;      /**< min z coordinate in the grid in psi data */
    real psigrid_z_max;      /**< max z coordinate in the grid in psi data */
    ...
    real Bgrid_r_min;        /**< min r coordinate in the grid in B data */
    real Bgrid_r_max;        /**< max r coordinate in the grid in B data */
    real Bgrid_z_min;        /**< min z coordinate in the grid in B data */
    real Bgrid_z_max;        /**< max z coordinate in the grid in B data */
    real Bgrid_phi_min;      /**< min phi coordinate in the grid in B data */
    real Bgrid_phi_max;      /**< max phi coordinate in the grid in B data */
    real Bgrid_t_min;        /**< min time coordinate in the grid in B data */
    real Bgrid_t_max;        /**< max time coordinate in the grid in B data */
...
int B_3DST_init_offload(
    B_3DST_offload_data* offload_data, real** offload_array);
void B_3DST_free_offload(
    B_3DST_offload_data* offload_data, real** offload_array);
...
a5err B_3DST_eval_psi(
    real psi[1], real r, real phi, real z, B_3DST_data* Bdata);
#pragma omp declare simd uniform(Bdata)
...
#pragma omp declare simd uniform(Bdata)
a5err B_3DST_eval_B(
    real B[3], real r, real phi, real z, real t, B_3DST_data* Bdata);
#pragma omp declare simd uniform(Bdata)
a5err B_3DST_eval_B_dB(real B_dB[12], real r, real phi, real z, real t,
                      B_3DST_data* Bdata);
#pragma omp declare simd uniform(Bdata)
a5err B_3DST_get_axis_rz(real rz[2], B_3DST_data* Bdata);
