...
void libascot_rhotheta2rz(
    B_field_data *bfield, int Neval, int maxiter, real tol, real t, real *rho,
...
void libascot_eval_ratecoeff(
    ...
    asigma_data *atomic, int Neval, real *R, real *phi, real *z, real *t,
...
void libascot_eval_rfof(
    B_field_data *bfield, rfof_data *rfof, int Neval, real *R, real *phi,
