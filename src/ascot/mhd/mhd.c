...
void mhd_free(Mhd *mhd)
{
    ...
    {
    case mhd_type_stat:
        mhd_stat_free(mhd->stat);
        break;
    case mhd_type_nonstat:
        mhd_nonstat_free(mhd->nonstat);
        break;
    }
}
...
void mhd_offload(Mhd *mhd)
{
    ...
    {
    case mhd_type_stat:
        mhd_stat_offload(mhd->stat);
        break;
    case mhd_type_nonstat:
        mhd_nonstat_offload(mhd->nonstat);
        break;
    }
}
    ...
    Boozer *boozer, Mhd *mhd, Bfield *bfield)
{
    ...
    case mhd_type_stat:
        err = mhd_stat_eval(
            mhd_dmhd, r, phi, z, t, includemode, boozer, mhd->stat, bfield);
        break;

    case mhd_type_nonstat:
        err = mhd_nonstat_eval(
            mhd_dmhd, r, phi, z, t, includemode, boozer, mhd->nonstat, bfield);
        break;
    ...
    int includemode, Boozer *boozer, Mhd *mhd, Bfield *bfield)
{
    ...
    case mhd_type_stat:
        err = mhd_stat_perturbations(
            pert_field, r, phi, z, t, pertonly, includemode, boozer, mhd->stat,
            bfield);
        break;

    case mhd_type_nonstat:
        err = mhd_nonstat_perturbations(
...
int mhd_get_n_modes(Mhd *mhd)
{
    ...
    {
    case mhd_type_stat:
        val = mhd->stat->n_modes;
        break;
    case mhd_type_nonstat:
        val = mhd->nonstat->n_modes;
        break;
    }
    return val;
}
...
const real *mhd_get_amplitude(Mhd *mhd)
{
    ...
    {
    case mhd_type_stat:
        val = mhd->stat->amplitude_nm;
        break;
    case mhd_type_nonstat:
        val = mhd->nonstat->amplitude_nm;
        break;
    }
    return val;
}
...
const real *mhd_get_frequency(Mhd *mhd)
{
    ...
    {
    case mhd_type_stat:
        val = mhd->stat->omega_nm;
        break;
    case mhd_type_nonstat:
        val = mhd->nonstat->omega_nm;
        break;
    }
    return val;
}
...
const real *mhd_get_phase(Mhd *mhd)
{
    ...
    {
    case mhd_type_stat:
        val = mhd->stat->phase_nm;
        break;
    case mhd_type_nonstat:
        val = mhd->nonstat->phase_nm;
        break;
    }
    return val;
}
