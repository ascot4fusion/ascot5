 ...
 */
void dist_6D_update_fo(dist_6D_data* dist, MarkerGyroOrbit* p_f,
                       MarkerGyroOrbit* p_i) {
...
#ifndef GPU
    for(size_t i = 0; i < p_f->n_mrk; i++) {
        if(p_f->running[i] && index[i] < dist->step_7 * dist->n_r) {
            GPU_ATOMIC
 ...
 */
void dist_6D_update_gc(dist_6D_data* dist, MarkerGuidingCenter* p_f,
