...
void step_ml_cashkarp(MarkerFieldLine* p, real* h, real* hnext, real tol,
                      Bfield* bfield) {
    ...
    for(int i = 0; i < NSIMD; i++) {
        if(p->running[i]) {
            ...
            if(!errflag) {
                errflag = Bfield_eval_b(k2, tempy[0], tempy[1], tempy[2],
                                         t0 + (1.0/5)*h[i], bfield);
            }
            ...
            if(!errflag) {
                errflag = Bfield_eval_b(k3, tempy[0], tempy[1], tempy[2],
                                         t0 + (3.0/10)*h[i], bfield);
            }
            ...
            if(!errflag) {
                errflag = Bfield_eval_b(k4, tempy[0], tempy[1], tempy[2],
                                         t0 + (3.0/5)*h[i], bfield);
            }
            ...
            if(!errflag) {
                errflag = Bfield_eval_b(k5, tempy[0], tempy[1], tempy[2],
                                         t0 + h[i], bfield);
            }
            ...
            if(!errflag) {
                errflag = Bfield_eval_b(k6, tempy[0], tempy[1], tempy[2],
                               t0 + (7.0/8)*h[i], bfield);
            }
 ...
 */
void step_ml_cashkarp_mhd(MarkerFieldLine* p, real* h, real* hnext, real tol,
                          Bfield* bfield, Boozer* boozerdata,
                          Mhd* mhddata) {
