...
a5err atomic_rates(
    ...
    const int *z_2, const int *a_2, const real *m_2, asigma_data *asigma, int q,
        ...
        if (p->running[i])
        {
            ...
            if (!errflag)
            {
                errflag = atomic_rates(
                    ...
                    p->mass[i], z_2, a_2, m_2, asigmadata, q, E, N_pls_spec,
...
a5err atomic_rates(
    ...
    int q, real E, int N_pls_spec, int N_ntl_spec, real *T, real *T_0, real *n,
    real *n_0)
{
    a5err err = 0;
