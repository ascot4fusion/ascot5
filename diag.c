 ...
 * it is enough that one add calls to that diagnostics routines here. One
 * limitation for diagnostic data is that the size of the data must be known
 * before simulation begins so that offloading that data is possible.
 *
...
void diag_sum(diag_data* d, real* array1, real* array2) {
    ...
    if(d->diag_distrho5D_collect){
        ...
        int stop = start + d->distrho5D.n_rho * d->distrho5D.n_pol * d->distrho5D.n_phi
                   ...
                   * d->distrho5D.n_time * d->distrho5D.n_q;
    ...
    if(d->diag_distrho6D_collect){
        ...
        int stop = start + d->distrho6D.n_rho * d->distrho6D.n_pol * d->distrho6D.n_phi
                   ...
                   * d->distrho6D.n_time * d->distrho6D.n_q;
